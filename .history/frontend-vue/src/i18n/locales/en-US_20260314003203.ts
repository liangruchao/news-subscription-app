export default {
  ...
  rss: {
    ...
    feedUrlPlaceholder: 'Enter RSS feed URL, e.g., https://example.com/feed',
    searchPlaceholder: 'Search RSS feeds',
    allCategories: 'All Categories',
    noFeeds: 'No RSS feeds available',
  ...
  articleDetail: {
    ...
    tagsHint: 'Separate multiple tags with commas, e.g., Technology,Vue,Frontend',
    existingTags: 'Existing tags (click to add)',
